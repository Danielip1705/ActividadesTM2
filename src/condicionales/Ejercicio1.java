...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		if (num >= 10 && num < 100) {
			// Indicamos con if que si num/10 es lo mismo que num%10(para saber si el
			// coficiente es igual al resto)
			if ((num / 10) == (num % 10)) {
		...
		if (num >= 100 && num < 1000) {
			// Indicamos con if que haga la operacion num/10 == num%100(para saber si el
			// coficiente es igual al resto)
			if ((num / 100) == (num % 100)) {
